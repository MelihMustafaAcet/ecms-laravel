              ...
              <table class="table table-striped">
                  ...
                  @foreach($data['slider'] as $slider)
                      <tr id="item-{{$slider->id}}">
                          <td class="sortable" width="150"><img width="150" height="150" src="/images/sliders/{{$slider->slider_file}}" alt=""></td>
...
$(function(){
    ...
    alertify.confirm('Silme işlemini onayla!','Bu işlem geri alınamaz',
    function (){
        $.ajax({
            type:"DELETE",
