...
<div class="login-box">
    <div class="login-logo">
        <a style="color: white;" href="{{route('nedmin.Login')}}"><b>Mel </b>Yazılım</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Kullanıcı Adı ve Şifrenizi Yazınız...</p>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input name="remember_me"  type="checkbox" {{old('remember_me') ? 'checked' : ''}}> Beni Hatırla
                        </label>
                    </div>
                </div>
                <!-- /.col -->
