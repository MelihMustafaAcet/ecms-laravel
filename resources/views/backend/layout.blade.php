...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li ><a href="{{route('blog.index')}}"><i class="fa fa-paper-plane"></i> <span>Bloglar</span></a></li>
                <li ><a href="{{route('page.index')}}"><i class="fa fa-sticky-note"></i> <span>Sayfalar</span></a></li>
                <li ><a href="{{route('slider.index')}}"><i class="fa fa-sticky-note"></i> <span>Sliderler</span></a></li>
                                ...
                                <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li ><a href="{{route('user.index')}}"><i class="fa fa-user-circle-o"></i> <span>Kullanıcılar</span></a></li>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="#">NE</a>.</strong> All rights reserved.
    </footer>
